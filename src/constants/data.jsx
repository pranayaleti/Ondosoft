...
export const testimonials = [
  {
    ...
    image: user1,
    text: "Ondosoft transformed our business. We went from 100 to 10,000+ users in just 6 months with zero downtime. Their architecture decisions saved us months of refactoring later.",
    metric: "10,000+ users",
  ...
  },
  {
    ...
    image: user2,
    text: "We needed a custom web app for our startup and Ondosoft delivered exactly what we needed. Professional, fast, and the code quality is enterprise-grade. They're now our long-term partner.",
    metric: "40%",
  ...
  },
  {
    ...
    company: "ScaleUp AI",
    image: user3,
    text: "Working with Ondosoft felt like having a senior in-house team. Direct access to engineers, weekly demos, and they actually understood our AI product vision. Budget-friendly too.",
    metric: "3x",
  ...
  },
  {
    ...
    company: "ShopStream",
    image: user4,
    text: "Ondosoft built our entire e-commerce platform from scratch. The attention to UX detail is outstanding. Our conversion rate improved by 85% compared to the previous vendor's work.",
    metric: "85%",
  ...
  },
  {
    ...
    image: user5,
    text: "HIPAA compliance, real-time data pipelines, patient portals. Ondosoft handled it all with the kind of security rigor we needed. They made the complex feel simple.",
    metric: "99.9%",
  ...
  },
  {
    ...
    company: "NeuralPay",
    image: user6,
    text: "We needed a complex SaaS platform with Stripe integration, multi-tenancy, and real-time analytics. Ondosoft delivered beyond our expectations. They're our go-to development partner.",
    metric: "$2M+",
